...
void test_validate_my_username()
{
    ...
    TEST_ASSERT_EQUAL_STRING_MESSAGE(my_username(), username_conf, "Username doesn't match with config file");
    /* Free username extracted from conf file after use */
    if (NULL != username_conf)
    {
	free(username_conf);
	username_conf = NULL;
    }
